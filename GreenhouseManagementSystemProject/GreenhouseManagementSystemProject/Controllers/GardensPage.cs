...
namespace GreenhouseManagmentSystem.Controllers
{
    public partial class GardensPage : Form
    {
        ...
        private void GardenDataGrid_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void GardensPage_Load(object sender, System.EventArgs e)
        {
            // TODO: This line of code loads data into the 'greenhouseDataSet.Sensors' table. You can move, or remove it, as needed.
            this.sensorsTableAdapter.Fill(this.greenhouseDataSet.Sensors);
